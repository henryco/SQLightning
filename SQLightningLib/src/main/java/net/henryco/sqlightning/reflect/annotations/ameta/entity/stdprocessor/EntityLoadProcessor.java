...
public class EntityLoadProcessor implements MetaEntityLoaderExec {
	...
	public static final MetaLoaderExec loaderExec = new MetaLoaderExec() {
		@Override
		public Object getValue(Object instance, Field instanceField, SQLiteDatabase database, String tabName, Cursor data) {
