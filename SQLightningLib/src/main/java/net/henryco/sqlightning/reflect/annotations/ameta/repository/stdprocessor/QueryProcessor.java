...
public class QueryProcessor implements MetaQueryExec {
	...
	public Invokable getInvokable(final Method method, final Annotation metaHolder,
		...
		final Query query = (Query) metaHolder;

		final Read read = method.getAnnotation(Read.class);
		final Write write = method.getAnnotation(Write.class);
