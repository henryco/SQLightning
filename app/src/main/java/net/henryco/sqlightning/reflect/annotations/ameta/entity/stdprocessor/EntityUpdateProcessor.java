...
public class EntityUpdateProcessor implements MetaEntityUpdaterExec {
	...
	@Override
	public ActionTree saveEntity(Object entity, SQLiteDatabase database,
								 String tableName, Object parentKey) {
		...
		return actionTree.setAction(() -> database.update(tableName, values, where, args));
	}
}
