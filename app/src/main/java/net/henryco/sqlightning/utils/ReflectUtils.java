...
public final class ReflectUtils {
	...
	private interface ArrayGetter {
		ArrayGetter arrayGetter = java.lang.reflect.Array::get;
		ArrayGetter listGetter = (array, index) -> ((List) array).get(index);
		Object get(Object array, int index);
	}
	private interface ArraySizer {
		ArraySizer arraySizer = java.lang.reflect.Array::getLength;
		ArraySizer listSizer = array -> ((List) array).size();
